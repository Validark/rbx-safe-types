...
Although unrecommended, if you *really* want to take this idea for yourself, and work on it yourself, you may fork [Validark/rbx-safe-types/master](https://github.com/Validark/rbx-types/tree/master).
